{
    //handling data while submitting the post usinf AJAX
    let createPost = function(){
        let newPostForm = $('#new-post-form');
 
        newPostForm.submit(function(e){

            //disable the form to sutbmit naturally
            e.preventDefault();
            ...
            $.ajax({
                ...
                //this converts the post from form data into json
    ...
    let newPostDom = function(post){
        ...
        <li id="post-${post._id}">
                <p>
                    <small>
                        <a delete-post-button class="delete-post-button" href="/posts/destroy/${ post._id }">X</a>
                    </small>
